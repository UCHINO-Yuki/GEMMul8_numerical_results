function plot_flops_square(ARCH,PREC,OP)
%
...
arguments (Input)
    ...
    OP (1,1) string {mustBeMember(OP, ...
        ["gemm","trmm","trsm","trtrmm",...
        "symm","syrk","syr2k","syrkx", ...
        "hemm","herk","her2k","herkx"])} = "trtrmm";
end
ARCH = upper(ARCH);
PREC = lower(PREC);
OP   = lower(OP);
